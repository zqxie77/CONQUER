...
if __name__ == '__main__':
    ...
    sub = '/home/qinyang/projects/Text2ImagepPerson/NoiseRID/CONQUER_release/run_logs/CUHK-PEDES/20240316_232359_CONQUER_TAL+sr0.3_tau0.015_margin0.1_n0.0'
    parser.add_argument("--config_file", default=f'{sub}/configs.yaml')
    args = parser.parse_args()
    args = load_train_configs(args.config_file)
    args.training = False
    logger = setup_logger('CONQUER', save_dir=args.output_dir, if_train=args.training)
    logger.info(args)
    device = "cuda"
    args.output_dir =sub
